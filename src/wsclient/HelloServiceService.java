 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://mydemo.com/", wsdlLocation = "http://localhost:1212/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://mydemo.com/", "HelloServiceService");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://mydemo.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://mydemo.com/", "HelloServicePort"), HelloService.class, features);
    }
